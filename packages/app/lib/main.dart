...
class Main extends WatchingWidget {
  ...
  Widget build(final BuildContext context) {
    ...
    final ThemeMode themeMode = watchPropertyValue((final ThemeModeNotifier n) => n.value);
    final YaruVariant yaruVariant = watchPropertyValue((final ColorNotifier n) => n.value).yaruVariant;
