...
class Settings extends WatchingWidget {
  ...
  Widget build(final BuildContext context) {
    ...
    final ThemeMode themeBrightness = watchPropertyValue((final ThemeModeNotifier n) => n.value);
    final Color themeColor = watchPropertyValue((final ColorNotifier n) => n.value) ?? YaruVariant.accents[0].color;
