...
mixin _$Preferences {
  ...
  @override
  String toString() {
    return 'Preferences(configRegions: $configRegions, configRegionsFirstMatch: $configRegionsFirstMatch, language: $language, themeMode: $themeMode, themeColor: $themeColor)';
  }
}
