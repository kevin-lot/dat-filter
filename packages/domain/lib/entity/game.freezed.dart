  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.nameOrCloneOf, nameOrCloneOf) ||
                other.nameOrCloneOf == nameOrCloneOf) &&
            const DeepCollectionEquality().equals(other.regions, regions));
  }

  @override
  int get hashCode => Object.hash(runtimeType, originalEl, nameOrCloneOf,
...
abstract mixin class $GameCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {XmlElement originalEl, String nameOrCloneOf, List<String> regions});
}
...
extension GamePatterns on Game {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Game() when $default != null:
        return $default(_that.originalEl, _that.nameOrCloneOf, _that.regions);
      case _:
        return orElse();
    }
  }
